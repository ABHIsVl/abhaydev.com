...
export default function AboutSection() {
  ...
  return (
    <SectionWrapper id="about" className="py-16 relative overflow-hidden mt-0">
      {/* Background elements */}
      ...
      <div ref={sectionRef} className="container mx-auto px-4 relative animate-fadeIn">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          {/* Animated Character Side */}
          <div ref={imageRef} className="w-full lg:w-2/5 relative order-2 lg:order-1 animate-slideUp">
